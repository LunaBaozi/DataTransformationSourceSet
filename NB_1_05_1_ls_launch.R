...
system.time(res_NB1_05_01 <- main_list(n_simulation = 5000, n=n, p=p,
...
save(res_NB1_05_01,file= paste0(path,"/../DataTransformationSourceSet/Results/resultsNB_1_05_01_list.RData"))