## RANDOMIZED QUANTILE RESIDUALS (NEGBIN) DATA ####
...
lapply(primaryset, cat, '\n', file = 'psRQR_nb.txt', append = T)
## Write big matrix into a file
write.csv(sumup, 'RQR_nb.csv')
...
rownames(newmatrix) <- 'RQRnb'
colnames(newmatrix) <- c('ptA', 'ptB', 'ptC', 'ptD', 'ptE',
                         'AB', 'AB+al.', 'A+al.', 'B+al.', 'Other', 'Empty', 'Full',
                         'Single', 'Time')

rownames(percent) <- 'RQRnb'
colnames(percent) <- c('ptA', 'ptB', 'ptC', 'ptD', 'ptE',
                       'AB', 'AB+al.', 'A+al.', 'B+al.', 'Other', 'Empty', 'Full',
                       'Single', 'Time')

write.csv(newmatrix, 'collapsedRQRnb_counts.csv')
write.csv(percent, 'collapsedRQRnb_percent.csv')
